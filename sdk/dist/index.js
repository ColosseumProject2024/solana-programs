...
const hex_1 = require("@coral-xyz/anchor/dist/cjs/utils/bytes/hex");
class DevoltClient {
    ...
    batteryReport({ id, latitude, longitude, maxCapacity, batteryLevel }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const decodedData = (0, hex_1.decode)(tx.instructions[0].data.toString());
            // const decodedData = deserialize(instructionSchema, 'batteryReport', tx.instructions[0].data);
            console.log('Decoded Data:', decodedData);
            yield (0, web3_js_1.sendAndConfirmTransaction)(this.connection, tx, [this.wallet.payer]);
        });
    }
    getStation(id) {
        return __awaiter(this, void 0, void 0, function* () {
